...
- (void)loadNocList
{
    ...
    for (NSDictionary *agDict in agentsJSON)
    {
        Agent *anAgent = [Agent agentWithDictionary:agDict];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"agentTableCell" forIndexPath:indexPath];
