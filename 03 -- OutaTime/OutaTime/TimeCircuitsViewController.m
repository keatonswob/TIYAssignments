...
- (void)viewDidLoad
{
    ...
    self.presentTimeLabel.text = [gDate stringFromDate:[NSDate date]];
    ...
    //
    self.speedLabel.text = [NSString stringWithFormat:@"%ld MPH", (long) cSpeed];
...
- (void)destinationDateWasChosen:(NSDate *)destinationDate
{
    ...
    self.destinationTimeLabel.text = [gDate stringFromDate:destinationDate];
